"""Curated UniPool travel trivia bank.

Questions here are intentionally stable, India-focused travel/geography facts.
Each item has a stable id so clients can exclude recently-seen questions and
avoid repetitive consecutive rounds.
"""
