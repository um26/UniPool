...
const makeStyles = (colors: any) => StyleSheet.create({
  ...
  sub: { color: colors.muted, fontSize: 9, marginTop: 2 },
  ...
  name: { color: colors.onSurface, fontSize: 11, fontWeight: "900" },
  preview: { color: colors.muted, fontSize: 9, marginTop: 2 },
  badge: { minWidth: 20, height: 20, paddingHorizontal: 5, borderRadius: 10, backgroundColor: colors.saffron, alignItems: "center", justifyContent: "center" },
  badgeText: { color: "#fff", fontSize: 9, fontWeight: "900" },
  empty: { padding: SPACING.md },
  emptyText: { color: colors.muted, fontSize: 10, lineHeight: 15, textAlign: "center" },
  all: { minHeight: 40, borderTopWidth: 1, borderTopColor: colors.border, marginTop: 4, paddingHorizontal: 8, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  allText: { color: colors.indigo, fontSize: 10, fontWeight: "900" },
  ...
  fabBadge: { position: "absolute", top: -4, right: -4, minWidth: 19, height: 19, paddingHorizontal: 4, borderRadius: 10, backgroundColor: colors.saffron, borderWidth: 2, borderColor: colors.card, alignItems: "center", justifyContent: "center" },
