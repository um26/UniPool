...
const PROTECTED_ROOTS = new Set(["post-request", "games", "chat", "pool", "trip-tools", "heatmap", "trip-receipt", "network", "settings", "notifications", "circles", "people", "campus", "budget"]);
