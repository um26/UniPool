...
const PROTECTED_ROOTS = new Set(["post-request", "games", "chat", "pool", "trip-tools", "match-preferences", "heatmap", "trip-receipt", "network", "settings", "notifications", "circles", "people", "campus", "budget"]);
...
function AuthGate() {
  ...
  return <View style={{ flex: 1, backgroundColor: colors.surface }}>{user ? <WebTopBar /> : null}<View style={{ flex: 1 }}><Stack screenOptions={{ headerShown: false, contentStyle: { backgroundColor: colors.surface }, animation: "fade_from_bottom" }}>
    <Stack.Screen name="index" /><Stack.Screen name="(tabs)" /><Stack.Screen name="terms" options={{ animation: "slide_from_right" }} /><Stack.Screen name="privacy" options={{ animation: "slide_from_right" }} /><Stack.Screen name="faq" options={{ animation: "slide_from_right" }} /><Stack.Screen name="community-guidelines" options={{ animation: "slide_from_right" }} />
    <Stack.Screen name="post-request" options={{ presentation: "modal", animation: "slide_from_bottom" }} /><Stack.Screen name="settings" options={{ animation: "slide_from_right" }} /><Stack.Screen name="notifications" options={{ animation: "slide_from_right" }} /><Stack.Screen name="people" options={{ animation: "slide_from_right" }} /><Stack.Screen name="campus" options={{ animation: "slide_from_right" }} /><Stack.Screen name="budget" options={{ animation: "slide_from_right" }} />
    <Stack.Screen name="circles/index" options={{ animation: "slide_from_right" }} /><Stack.Screen name="circles/personal" options={{ animation: "slide_from_right" }} /><Stack.Screen name="circles/[groupId]" options={{ animation: "slide_from_right" }} /><Stack.Screen name="circles/[groupId]/tools" options={{ animation: "slide_from_right" }} /><Stack.Screen name="circles/[groupId]/report" options={{ animation: "slide_from_right" }} />
    ...
    <Stack.Screen name="chat/[userId]" options={{ animation: "slide_from_right" }} /><Stack.Screen name="chat/group/[conversationId]" options={{ animation: "slide_from_right" }} /><Stack.Screen name="pool/[poolId]" options={{ animation: "slide_from_right" }} /><Stack.Screen name="trip-tools/[poolId]" options={{ animation: "slide_from_right" }} /><Stack.Screen name="match-preferences/[poolId]" options={{ animation: "slide_from_right" }} /><Stack.Screen name="network" options={{ animation: "slide_from_right" }} /><Stack.Screen name="heatmap" options={{ animation: "slide_from_right" }} /><Stack.Screen name="trip-receipt/[poolId]" options={{ animation: "slide_from_bottom" }} />
  </Stack></View>{user ? <SiteFooter /> : null}{user ? <FloatingChatLauncher /> : null}{user ? <ContextToolsLauncher /> : null}{user ? <ConsentGate /> : null}</View>;
}
