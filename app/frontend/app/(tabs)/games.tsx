  ...
  return (
    <SafeAreaView style={styles.safe} edges={["top"]}>
      ...
      <ScrollView contentContainerStyle={{ padding: SPACING.lg, paddingBottom: 140 }}>
        ...
        >
          <Image
            source={{ uri: "https://images.unsplash.com/photo-1582217900003-2b19c0e3a7d0?crop=entropy&cs=srgb&fm=jpg&w=1200&q=85" }}
            style={StyleSheet.absoluteFill}
            contentFit="cover"
          />
          <LinearGradient colors={["rgba(26,35,126,0.05)", "rgba(26,35,126,0.85)"]} style={StyleSheet.absoluteFill} />
          <View style={styles.cardBody}>
            <View style={styles.tagRow}><Ionicons name="bulb" size={14} color={COLORS.cream} /><Text style={styles.tag}>TRIVIA</Text></View>
            <Text style={styles.cardTitle}>Travel Trivia — Bharat Edition</Text>
            <Text style={styles.cardSub}>5 quick questions. Rails, wings & wanderlust.</Text>
          </View>
        </Pressable>

        <Pressable
          testID="game-tap-plane-card"
          onPress={() => { Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); router.push("/games/tap-plane"); }}
          style={styles.card}
        >
          <Image
            source={{ uri: "https://images.unsplash.com/photo-1436491865332-7a61a109cc05?crop=entropy&cs=srgb&fm=jpg&w=1200&q=85" }}
            style={StyleSheet.absoluteFill}
            contentFit="cover"
          />
          <LinearGradient colors={["rgba(255,153,51,0.1)", "rgba(176,92,0,0.85)"]} style={StyleSheet.absoluteFill} />
          <View style={styles.cardBody}>
            <View style={styles.tagRow}><Ionicons name="airplane" size={14} color={COLORS.cream} /><Text style={styles.tag}>ARCADE</Text></View>
            <Text style={styles.cardTitle}>Tap-the-Plane</Text>
